...
television="googletv viera smarttv internet.tv netcast nettv appletv boxee kylo roku dlnadoc roku pov_tv hbbtv ce-html".split(" ");for(a=0;a<television.length;){if(c(television[a]))return!0;a++}return!1};a.portrait=function(){return 1<window.innerHeight/window.innerWidth};a.landscape=function(){return 1>window.innerHeight/window.innerWidth};a.noConflict=function(){window.device=b;return this};c=function(a){return-1!==m.indexOf(a)};h=function(a){return e.className.match(RegExp(a,"i"))};d=function(a){h(a)||
...
(newSelectorRule=selectors.replace(RegExp(e,"g"),d),newRule=a.cssText.replace(/([^{]*)?/,newSelectorRule+" "),c===CSSRule.STYLE_RULE&&(sheet.deleteRule(j),sheet.insertRule(newRule,j)),c===CSSRule.MEDIA_RULE&&(sheet.cssRules[j].deleteRule(f),sheet.cssRules[j].insertRule(newRule,f)))};function _checkboxRadio(){for(var a=document.querySelectorAll('[type="checkbox"]:not(.filed-upgrade):not(.icon):not(.hidden),[type="radio"]:not(.filed-upgrade):not(.icon):not(.hidden)'),b=a.length,d,e;b--;){e=a[b].id;e||(a[b].id=e="chr-"+b);a[b].classList.add("filed-upgrade");if(-1==a[b].parentNode.className.indexOf("btn-group")){d=document.createElement("LABEL");d.classList.add("checkbox_radio");d.setAttribute("for",e);var c=a[b],g=c.parentNode;(c=c.nextSibling)?g.insertBefore(d,c):g.appendChild(d)}"LABEL"==
a[b].parentNode.nodeName&&a[b].parentNode.setAttribute("for",e)}}_checkboxRadio();function _tabs(){$(".tabs").tabs()}_tabs();
